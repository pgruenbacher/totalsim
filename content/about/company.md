...
As your Computational Fluid Dynamics (CFD) design team, we take innovative design ideas from initial concept to high-performance reality.

We stand for innovation with more than 100 years of combined design experience. We are industry-impacting with design teams in Dublin, Ohio, and Brackley, England who serve organizations of all sizes, budgets, and timetables.

We deliver innovative consulting, development, training, installation and support using leading-edge OPEN and commercial tools.

# Team

{{< avatar src="/images/placeholder.png" direction="left" >}}
## Ray Leto
{{<email email="spam@free.com">}}
...
Although Greg has only been with us a short time he's already become our go-to ANSA pre-processing expert.
...
Mark Swift joined TotalSim in April 2012 after completing his BS in Aerospace Engineering at the University of Minnesota.

During his time at Minnesota Mark worked as a Research Associate at the Organelle Research Group on Microfluidics. As well Mark worked as a software development engineer.

Along with his aerodyamnics and fluids work with TotalSim, Mark has, in his first year with us, become one of our best Python, database, and interface programmers.
...
Andy Luo, based in southern California, joined TotalSim in November 2012 after six years at Swift Engineering.

Andy received both his BSc and Msc from USC and has extensive experience in aerospace work including 2D and 3D airfoil and aircraft design using CFD, Wind Tunnel, and flight testing. As well, during his time at Swift Andy work on automotive and race car work. Andy was responsible for some really cool CFD work showing a race car during an active passing maneuver - all done in CFD. He is also an wiz at creating pre-processing and post processing tools using simple software interfaces like Excel.

We are really excited to have Andy on-board focusing on the aerospace industry.
...
Miguel has joined TotalSim in Sept of 2013 after receiving his BS in Aerospace Engineering from OSU. Miguel had focused on some interesting projects in scholl inclusing land mine detection and design of a motor glider.

At TotalSim, Miguel has focused on geometry prep, OpenFOAM case building and has turned into one of the go-to engineers we have for industrial and specialty problems.
...
Ryan has joined TotalSim as an intern for the summer of 2013 while he worked on his MS in Aerospace Engineering at The Ohio State University. Ryan received his BS in 2012 from OSU.

Ryan then joined TotalSim fulltime in Jan of 2014. Prior to TotalSim he was an Undergrad Research Associate at the Aero-Astro Research Lab at OSU working mostly in the GE Engine test cell facility.

Ryan is focused on geometry prep and learning OpenFOAM during his internship and now full time he's managing full CFD project from geometry prep, thru solving and post-processing. Ryan's also been applying his scripting an programming skill to our process.
...
David Hesse, a 30 year veteran of Battelle Memorial Institute in Columbus, OH, joined TotalSim as our Senior Research Engineer in July of 2014.

As a principal research scientist at Battelle, David has performed many CFD analyses for a wide range of clients in the Department of Defense, Department of Energy, numerous commercial ventures including the petroleum industry, chemical process industries, biomedical industry, and toxicological testing. He has applied commercial CFD packages, public domain codes, as well as written his own codes for special project needs. David was also involved in the space shuttle program, probabilistic fracture mechanics, electro-hydrodynamic applications, nuclear processes, X-ray lithography, mathematics for data mining, chemical micro-reactor design, biofilm modeling, atmospheric transport, and 3D printing among others.

We are really excited to have David on-board as we expand our reach into process engineering and broader industry.
...
For several Years TotalSim has employed a graduate student working on the Ohio State Buckeye Bullet Team The team operates out of the Center for Automotive Research at OSU with the student serving as it's new Aerodynamics Team Leader. Cary Bork and Casie Clark are the two most recent interns from this program.

Both have now graduted with MS's in Aerospace - Cary working in WA for Boeing and Casie for Lockheed in GA.

During the internships, the students used the resources, methods, and optimization techniques at TotalSim to help finalize the design the next generation Buckeye Bullet, the BB2.5 and now the BB3 which aims to eclipse their record at over 400mph. TotalSim is proud to help the Buckeye Bullet program and to have had these students as part of our team.
